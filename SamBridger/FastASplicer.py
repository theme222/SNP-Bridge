...
from InsertionDeletionFinder import sequenceAligner, fastA_parser
...
def display_simulation(
        size, type_a, type_b, blend_a, blend_b, bridge):  # just a way to plot the results of the simulation
    ...
    # plotting baseline
    plot1.plot([0, size], np.full(2, y_graph), 'k-')
